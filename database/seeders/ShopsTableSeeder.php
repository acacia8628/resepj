...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'img_path' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/sushi.jpg',
            'public' => 1,
        ];
        ...
        $param = [
            ...
            'img_path' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/yakiniku.jpg',
            'public' => 1,
        ];
        DB::table('shops')->insert($param);
        $param = [
            ...
            'img_path' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/izakaya.jpg',
            'public' => 1,
        ];
        DB::table('shops')->insert($param);
        $param = [
            ...
            'img_path' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/italian.jpg',
            'public' => 1,
        ];
        DB::table('shops')->insert($param);
        $param = [
            ...
            'img_path' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/ramen.jpg',
            'public' => 1,
        ];
        DB::table('shops')->insert($param);
        $param = [
